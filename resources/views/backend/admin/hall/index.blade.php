    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            <a class="btn btn-primary" href="{{route('admincreate.hall')}}">
                                Add New
                            </a>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Hall Information </h4>
                </div>
                ...
                <div class="pb-20">
                    <table class="table hover table-bordered multiple-select-row data-table-export nowrap">
                        ...
                        @foreach($hall as  $hall)
                            <tr>
                                <td class="table-plus">{{$hall->id}}</td>
                                <td width="340px">{{$hall->name}}</td>
                                <td width="240px">{{$hall->hall_capacity}}</td>
                                <td width="240px">{{$hall->created_at}}</td>
                                <td>
                                    <div>
