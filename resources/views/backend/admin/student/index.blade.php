        ...
        <div class="min-height-200px">
            ...
            @endif
                ...
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Student's Report </h4>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach($student as  $student)
                                    <tr>
                                        ...
                                        <td width="340px">{{$student->fullName}}</td>
                                        <td width="240px">{{$student->faculty}}</td>
                                        <td width="240px">{{$student->department}}</td>
                                        <td>{{$student->matricNumber}}</td>
                                        <td>{{$student->gender}}</td>
                                        <td>{{$student->level}}</td>
                                        <td>{{$student->phoneNumber}}</td>
                                        <td style="text-transform: lowercase;">{{$student->email}}</td>
                                        <td width="240px">{{$student->created_at}}</td>
                                        <td>
                                            <div>
